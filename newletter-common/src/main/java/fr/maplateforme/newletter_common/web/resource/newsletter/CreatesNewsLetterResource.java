...
public class CreatesNewsLetterResource {
    ...
    public ResponseEntity<NewsLetterDTO> handle(final BearerTokenAuthentication principal, final @RequestBody @Valid CreateNewsletterDTO request) throws NewsLetterAlreadyExistsException {
